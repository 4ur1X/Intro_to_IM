...
int TimeStamp = 45; // starting point of progress bar as it's located from x = 45

int which_song=2; // 2nd song
int which_artist=2; // 2nd artist
...
class TunesUI {
  ...
  // To load all the artists images to be displayed on the PLAY screen
  void load_images() {
    tunes_logo = loadImage("Images/tunes.png");
    bg = loadImage("Images/bg2.jpg");
    reset_button = loadImage("Images/reset_button.png");
    music_logo = loadImage("Images/music-logo.png");
    round = loadImage("Images/round.png");
    back_button = loadImage("Images/back.png");
    instructions_logo = loadImage("Images/instructions.png");
    instructions_bg = loadImage("Images/instructions_bg.png");

    // loading each artist
    artists = new PImage[6];
    for (int i=0; i<6; i++) {
      artists[i] = loadImage("Images/artist" + i + ".png");
    }
  }

  // Contains the graphical part of the initial screen
  void initial_screen() {
  ...
  // The actual screen where the song starts playing
  void play_screen() {
  ...
  // To change the artist and song title when song is changed
  ...
  // The next and previous buttons to change songs
  void next_previous() {
    fill(255);
    pushMatrix();
    translate(300, 485);
  ...
  // The screen where the user gets to explore and choose the song
  void explore() {
...
void setup() {
  ...
  for (int i=0; i<6; i++) {
    playlist[i] = minim.loadFile("Songs/song" + i + ".mp3");
  }
