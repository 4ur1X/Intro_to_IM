...
On the right is the GIF of the finished EXPLORE screen (containing names of the music artists). To choose a particular artist, the user should click on the green circle (similar to a button) located in the top-right corner in each box. 
